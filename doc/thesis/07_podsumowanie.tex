...
Jest kilka czynników wpływających negatywnie na szybkość wykonywania obliczeń w języku \textit{Python}. Przykładowymi czynnikami są fakt, że jest to język dynamicznie typowany, oraz to, że udostępnia relatywnie mało możliwości w zakresie zarządzania pamięcią. W celu przyspieszenia modułu odpowiedzialnego za grę w szachy, można by przepisać go w całości z języka \textit{Python} do języka takiego jak C++.