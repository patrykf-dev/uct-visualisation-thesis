...
\begin{enumerate}
	\item \textbf{Dodanie kolejnych gier} - obecna architektura projektu umożliwia rozszerzenie aplikacji o kolejne gry logiczne, które spełniają założenia algorytmu UCT. Zwiększenie liczby dostępnych gier daje więcej możliwości badania algorytmu UCT.
