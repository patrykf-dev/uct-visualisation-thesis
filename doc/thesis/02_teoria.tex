...
\begin{enumerate}
	...
	\item \textbf{Faza ekspansji} (linia 9 w listingu) -- utworzenie wierzchołków potomnych dla najbardziej obiecującego wierzchołka drzewa. Tworzone wierzchołki odpowiadają stanom możliwym do uzyskania przez wykonanie jednego ruchu ze stanu wierzchołka obiecującego.
