...
Diagram przypadków użycia\footnote{Grafika stworzona przy użyciu narzędzia na stronie: \url{https://www.lucidchart.com/} -- na zasadzie \textit{free use}.}, który ilustruje przedstawione możliwości, znajduje się na Rysunku \ref{rys:usecase}.
...
\begin{table}[h!]
	...
	\begin{tabular}{|l|p{0.7\linewidth}|}
		...
		Wsparcie       & Aplikacja jest przeznaczona dla komputerów z systemami operacyjnymi Windows oraz Linux opartymi na dystrybucji Debian, na przykład Ubuntu. \\ \hline
	\end{tabular}
\end{table}
