...
\begin{table}[h!]
	...
	\begin{tabular}{|l|p{0.7\linewidth}|}
		...
		Wsparcie       & Aplikacja jest przeznaczona dla komputerów spełniających wymagania opisane w rozdziale \ref{chap:guides}. \\ \hline
	\end{tabular}
\end{table}
...
\begin{table}[h!]
	...
	\begin{tabular}{|l|l|}
		\hline
		\textbf{Osoba odpowiedzialna}   & \textbf{Napisana część } \\ \hline
		Patryk Fijałkowski 
		& \ref{chap:teoria}. \nameref{chap:teoria} \\
		& \ref{chap:impl}. \nameref{chap:impl} \\
		& \ref{subsec:uml}.-\ref{subsec:stany}. \nameref{chap:glowne_komp} \\
		& \ref{chap:insr_instalacji}. \nameref{chap:insr_instalacji} \\
		& \ref{sec:testy}. \nameref{chap:podsumowanie} \\ \hline
		
		Grzegorz Kacprowicz
		& \ref{chap:zal_pr}. \nameref{chap:zal_pr} \\
		& \ref{subsec:seq_roz}.-\ref{subsec:seq_vis}. \nameref{chap:glowne_komp} \\
		& \ref{chap:ui}. \nameref{chap:ui} \\
		& \ref{sec:kontynuacja}. \nameref{chap:podsumowanie} \\
