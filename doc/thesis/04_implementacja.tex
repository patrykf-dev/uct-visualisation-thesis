...
W przypadku mankali za główny czynnik pozwalający określić wypłatę dla gracza przyjęta została różnica pomiędzy punktami tego gracza, a punktami jego przeciwnika. Maksymalną liczbą punktów do uzyskania jest $48$, a minimalną $0$, stąd zakres wypłat wynosi $[-48, 48]$. Zastosowano funkcję liniową, która dla różnicy punktów wynoszącej $0$ przyjmuje wartość $0.5$. Wzór funkcji wyraża się jako: 
$$
f(x)=0.00625x + 0.5
$$
a jej reprezentację graficzną można ujrzeć na wykresie \ref{rys:eval_mancala}.
...
$$
a jej wykres znajduje się na rysuknu \ref{rys:eval_chess}.
