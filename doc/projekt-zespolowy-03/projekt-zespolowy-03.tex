...
\begin{table}[h!]
	...
	\begin{tabular}{|l|p{0.7\linewidth}|}
		...
		Wynik & Pozytywny - razem z deserializacją, wyświetlenie drzewa z pliku zajęło  2.802s. \\ \hline
	\end{tabular}
...
\begin{table}[h!]
	...
	\begin{tabular}{|l|p{0.7\linewidth}|}
		...
		Wynik & Pozytywny - razem z deserializacją, wyświetlenie drzewa z pliku zajęło  4.626s. \\ \hline
	\end{tabular}
