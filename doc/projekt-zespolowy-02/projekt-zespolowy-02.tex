...
\begin{document}
	...
	\end{figure}
	BBB fh ab bsdhjf hb hds hjafd b fdhbsj hsd jfj adfjsabjdsfh hfsdjf hbasdjfhsbd fjdbsa jhbsjaf bds hfb jfb hadfsdj b hjbs
	
	\clearpage
	\subsection{Diagram sekwencji serializacji}
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.8\textwidth]{serialize_sequence}
		\caption{Diagram sekwencji serializacji}
