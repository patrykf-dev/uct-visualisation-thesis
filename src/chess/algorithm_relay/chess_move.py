...
class ChessMove(BaseGameMove):
    ...
    def __init__(self, position_to, position_from, move_type=MoveType.NORMAL, help_dict=None):
        ...
        :param move_type: enum MoveType object (normal move, double pawn move, castling etc.). Default: MoveType.Normal
    ...
    def move_equal(self, move) -> bool:
        ...
        :return: bool, tells whether the moves are equal when it comes to the position and type
        """
    ...
    def real_position_to(self):
        ...
        example: (1, 4) -> b5
        :return: string of real game-based chessboard coordinates
        """
