...
class MainApplicationWindowLayout:
    ...
    def get_mc_settings(self) -> MonteCarloSettings:
        rc = MonteCarloSettings()
        rc.limit_moves = self.limit_moves_check.isChecked()
        rc.limit_iterations = self.max_iterations_button.isChecked()
        try:
            rc.max_iterations = int(self.max_iterations_edit.text())
            rc.max_time = int(self.max_time_edit.text())
            rc.max_moves_per_iteration = int(self.max_moves_edit.text())
        except ValueError:
